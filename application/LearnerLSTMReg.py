...
class LearnerLSTMReg(Learner):
    def learn(self):
        ...
        if not os.path.exists(model_json_file_addr) or continue_training:
            ...
            model = Sequential()
            model.add(LSTM(32, activation='relu', return_sequences=True, input_shape=input_shape, dropout=0.5))  # returns a sequence of vectors of dimension 32
            ...
            model.compile(loss='mean_absolute_error',
                          ...
                          metrics=['mae', 'mse'])  # top3_accuracy accuracy 'categorical_crossentropy' 'categorical_accuracy' multiclass_loss
